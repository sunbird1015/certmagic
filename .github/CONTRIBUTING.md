...
You can have a direct impact on the project by helping with its code. To contribute code to CertMagic, open a [pull request](https://github.com/sunbird1015/certmagic/pulls) (PR). If you're new to our community, that's okay: **we gladly welcome pull requests from anyone, regardless of your native language or coding experience.** You can get familiar with CertMagic's code base by using [code search at Sourcegraph](https://sourcegraph.com/github.com/sunbird1015/certmagic).
...
1. [Fork this repo](https://github.com/sunbird1015/certmagic). This makes a copy of the code you can write to.

2. If you don't already have this repo (sunbird1015/certmagic.git) repo on your computer, get it with `go get github.com/sunbird1015/certmagic`.

3. Tell git that it can push the sunbird1015/certmagic.git repo to your fork by adding a remote: `git remote add myfork https://github.com/you/certmagic.git`

4. Make your changes in the sunbird1015/certmagic.git repo on your computer.

5. Push your changes to your fork: `git push myfork`

6. [Create a pull request](https://github.com/sunbird1015/certmagic/pull/new/master) to merge your changes into sunbird1015/certmagic @ master. (Click "compare across forks" and change the head fork.)
...
Like every software, CertMagic has its flaws. If you find one, [search the issues](https://github.com/sunbird1015/certmagic/issues) to see if it has already been reported. If not, [open a new issue](https://github.com/sunbird1015/certmagic/issues/new) and describe the bug clearly.
